...
3. Name all the tables and columns that would make a 3NF compliant solution.
   ...
   Second Tabel: Dinnr table
   dinner_id is the Primary key
   ...
   Third Tabel: Venu Table
   venue_code is the Primary key
   ...
   Fourth Table: Food Table
   food_code is the Primary key
